  ...
  for(weekday of days){
    ...
    for (let nwday in emp.nwdays) {
      ...
      let findViableday =emp.availableNWdays.findIndex((object) => {
        return object == emp.nwdays[nwday];
      });
    ...
    for (let ofday in emp.offdays.aldays) {
      let findoffdayIndex =emp.availableNWdays.findIndex((object) => {
        return object === emp.offdays.aldays[ofday];
      });
    emp.availableNWdays.splice(findoffdayIndex, 1);
    }
    for (let ofday in emp.offdays.hrdays) {
      let findoffdayIndex =emp.availableNWdays.findIndex((object) => {
        return object === emp.offdays.hrdays[ofday];
      });
    emp.availableNWdays.splice(findoffdayIndex, 1);
    }
    for (let ofday in emp.offdays.mldays) {
      let findoffdayIndex =emp.availableNWdays.findIndex((object) => {
        return object === emp.offdays.mldays[ofday];
      });
    emp.availableNWdays.splice(findoffdayIndex, 1);
    }
    for (let ofday in emp.offdays.swdays) {
      let findoffdayIndex =emp.availableNWdays.findIndex((object) => {
        ...
        return object === emp.offdays.swdays[ofday];
      });
    emp.availableNWdays.splice(findoffdayIndex, 1);
    }
    for (let ofday in emp.offdays.uldays) {
      let findoffdayIndex =emp.availableNWdays.findIndex((object) => {
        return object === emp.offdays.uldays[ofday];
      });
    emp.availableNWdays.splice(findoffdayIndex, 1);
    }
  }
